  ...
  className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6 md:p-8 text-center"
      >
        <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
          <Play className="w-8 h-8 text-gray-400 dark:text-gray-300" />
        </div>
  ...
  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4">
          ...
          <div className="order-1 sm:order-2 flex items-center space-x-2 justify-end w-full sm:w-auto">
            ...
            {typeof done !== 'undefined' && onToggleDone && (
              <button
                className={`flex items-center px-3 py-1 rounded-full text-sm font-medium transition-colors ${done ? 'bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300' : 'bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-200 hover:bg-green-100 dark:hover:bg-green-900 hover:text-green-700 dark:hover:text-green-300'}`}
